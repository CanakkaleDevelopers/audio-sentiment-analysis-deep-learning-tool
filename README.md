...
_In Feature extraction page, we can extract desired audio features from per auido._


<img  width="500" height="500" src="https://i.im.ge/2021/09/01/Q1PF51.png">
_In training page we can set validation test split, batch size, epoch count etc._
